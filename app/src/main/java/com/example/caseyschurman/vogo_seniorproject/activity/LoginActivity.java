...
* Purpose: LoginActivity is the activity for the login page.
* Summary: After user enters in login credentials and selects the login button, that information
* will be sent via a POST request to the PHP script (which is on 000freewebhost server) for actually
* validating against database. If credentials are validated, the user will be forwarded to the MainActivity.
* */
